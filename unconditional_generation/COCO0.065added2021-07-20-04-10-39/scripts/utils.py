        ...
        with open(path, 'r') as f:
            ...
            for line in f:
                ...
                if len(line.split()) > self.maxlen:
                    ...
                    continue
                # vectorize
                indices = self.bertTokenizer.encode_plus(line, add_special_tokens=True, max_length=self.maxlen, padding=True, return_attention_mask=False, return_tensors='pt')['input_ids']
                lines.append(indices.tolist()[0])
