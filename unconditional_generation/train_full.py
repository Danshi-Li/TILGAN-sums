...
from models import Seq2Seq, MLP_D, MLP_D_local, MLP_G, AE_BERT_enc, AE_GPT_dec, AE_BG
...
# exp dir
create_exp_dir(os.path.join(args.save), ['train_full.py', 'models.py', 'utils.py'],
...
autoencoder = AE_BG(add_noise=args.add_noise,
                      emsize=args.emsize,
...
def train():
    ...
    #debugging evaluate_autoencoder
    #print("evaluate_autoencoder debugging")
    #epoch = 1
