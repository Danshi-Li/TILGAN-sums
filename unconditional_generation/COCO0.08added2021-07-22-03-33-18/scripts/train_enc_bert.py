...
def train_gan_dec(gan_type='kl'):
    ...
    for i in range(100):
        print(enhance_shorce[0][0][i])
    enhance_hidden = autoencoder(torch.mean(enhance_source,2).long(), None, max_indices, add_noise=args.add_noise, soft=True, encode_only=True)
